...
public class UI_PauseMenu : UI_Panel 
{
    ...
    public void Initialize(UI_Pause ui_pause, UI_Gameplay ui_gameplay, UI_StatsMenu ui_statsMenu, UI_InventoryMenu ui_inventoryMenu, UI_SettingsMenu ui_settingsMenu)
    {
